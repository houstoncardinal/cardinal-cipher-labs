import { ArrowRight, Check, Star, Shield, Code, Database } from "lucide-react";
    ...
    <>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="font-serif text-5xl md:text-6xl lg:text-7xl text-gray-900 leading-tight mb-6">
              Technology Websites That <span className="text-red-600">Innovate</span>
            </motion.h1>
            ...
            <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
              Cutting-edge websites for technology companies, SaaS products, and IT services. Showcase your innovation.
            </motion.p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Comprehensive digital solutions for technology companies</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "SaaS Websites", description: "Modern websites that showcase your software products.", icon: Code },
              { title: "Product Demos", description: "Interactive demos and feature showcases.", icon: Star },
              { title: "Developer Docs", description: "Beautiful documentation for your products.", icon: Database },
              { title: "Tech SEO", description: "Rank for technical and product keywords.", icon: Star },
              { title: "Lead Generation", description: "Convert visitors into demo requests.", icon: Shield },
              { title: "Brand Design", description: "Memorable tech brand identity.", icon: Star },
            ].map((service, i) => (
      ...
      <section id="contact" className="py-20 bg-gray-900">
        <div className="container mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="text-gray-400 mb-10 max-w-2xl mx-auto">Let's discuss how we can help your tech company stand out.</p>
          <a href="/contact" className="inline-flex items-center gap-2 bg-red-600 text-white font-bold tracking-wider uppercase px-8 py-4 rounded-xl hover:bg-red-700 transition-all">
