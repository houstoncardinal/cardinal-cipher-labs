...
export const services = [
  ...
  },
  {
    ...
    description: 'Custom enterprise applications built with cutting-edge technologies and best practices for scalability and security.',
    provider: siteConfig.name,
    serviceType: 'Professional Service',
    areaServed: ['North America', 'Europe', 'Asia Pacific'],
    offers: {
  ...
  },
  {
    ...
    description: 'End-to-end security solutions protecting your digital assets with industry-leading practices and compliance.',
    provider: siteConfig.name,
    serviceType: 'Professional Service',
    areaServed: ['North America', 'Europe', 'Asia Pacific'],
    offers: {
  ...
  },
  {
    ...
    description: 'Strategic guidance for modernizing your technology stack and business processes for the digital age.',
    provider: siteConfig.name,
